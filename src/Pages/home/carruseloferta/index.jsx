    ...
    <div className={`col-md-${8 / cardsToShow} col-xl-${9 / cardsToShow}  mt-2 mb-2 me-5 ms-5 `}>
      <div className="card mb-2 " style={{ height: '100%', width:"350px" }}>
        ...
        <div className='ValoracionUsuarios d-flex mb-5'> <p className='fw-bold'>4.7</p></div>
          ...
          <h2 className="card-title mt-3">{paquete.nombre}</h2>
          ...
          <div className="Information d-flex flex-column align-items-end">
            <h3 className='text-secondary text-decoration-line-through'>{`CLP$${agregarPuntos(paquete.precio_vuelo * paquete.total_personas + paquete.precio_noche * diferenciaEnDias)}`}</h3>
            <h3 className='fw-bold '>{`CLP$${agregarPuntos(paquete.precio_oferta_vuelo * paquete.total_personas + paquete.precio_noche * diferenciaEnDias)}`}</h3>
          </div></div>
